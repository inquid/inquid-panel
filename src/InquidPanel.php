...
class InquidPanel extends Panel
{
    ...
    public function getDetail()
    {
        ...
        if(isset(Yii::$app->params['google_cloud_project_id']) && isset(Yii::$app->params['google_cloud_project_zone']) && isset(Yii::$app->params['google_cloud_project_instance'])&& isset(Yii::$app->params['google_cloud_project_number'])){
